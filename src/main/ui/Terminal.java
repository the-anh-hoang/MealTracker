...
public class Terminal {
    ...
    public void run() {
        ...
        System.out.println("First, please enter your name, weight, height, age, sex, and goals so we can best assist you!");
        ...
        System.out.println("Please choose from the options provided below by typing 1-7");
        ...
        while (true) {
            ...
            switch (choice) {
                ...
                case 5:
                System.out.print("How much food would you like your meal to be? (maximum " + (user.getFoods()).size() + " items): ");
